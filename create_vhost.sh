...
echo "	DocumentRoot $DIRECTORY" >> $PATH_APACHE_CONF$DOMAIN".conf"
echo "	ErrorLog $DIRECTORY/error_log" >> $PATH_APACHE_CONF$DOMAIN".conf"
echo "	CustomLog $DIRECTORY/access_log combined" >> $PATH_APACHE_CONF$DOMAIN".conf"
